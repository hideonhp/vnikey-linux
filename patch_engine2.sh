...
-            (Some('a'), 's') => self.buffer.replace_last('á'),
-            (Some('a'), 'f') => self.buffer.replace_last('à'),
-            (Some('a'), 'w') => self.buffer.replace_last('ă'),
-            (Some('o'), 'o') => self.buffer.replace_last('ô'),
-            (Some('d'), 'd') => self.buffer.replace_last('đ'),
